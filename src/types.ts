...
export type OfferStatus = 'creating_trade'
	| 'waiting_accept'
	| 'accepted'
	| 'canceled'
	| 'timeout'
...
export type SBSocketEventName = 'auth_success'
	| 'auth_failed'
	| 'buy_item'
	| 'status_change'
	| 'balance_change';
...
export type SBSocketData = AuthSuccess | AuthFailed | BuyItem | StatusChange | BalanceChange;
